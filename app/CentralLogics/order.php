...
use App\Http\Controllers\ReferralDistributionController;
class OrderLogic
{
    ...
    public static function create_transaction($order, $received_by = false, $status = null)
    {
        ...
        try {
            ...
            // Call the referral distribution method
            $referralDistributionController = new ReferralDistributionController();
            $referralDistributionController->distributeCommission($order->id);
