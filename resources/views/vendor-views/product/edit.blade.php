                        ...
                        <div class="card-body d-flex flex-column">
                                ...
                                <div class="row" id="coba">
                                    ...
                                    @php($photo = is_array($photo)?$photo:['img'=>$photo,'storage'=>'public'])
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 spartan_item_wrapper" id="product_images_{{ $key }}">
                                            <img class="img--square onerror-image" src="{{\App\CentralLogics\Helpers::onerror_image_helper($photo['img'], asset('storage/app/public/product/').'/'.$photo['img'], asset('assets/admin/img/400x400/img2.jpg'), 'product/',$photo['storage'] ?? 'public') }}"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-center d-block" id="image-viewer-section" class="pt-2">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/app/public/product/').'/'.$product['image'], asset('assets/admin/img/400x400/img2.jpg'), 'product/') }}"
