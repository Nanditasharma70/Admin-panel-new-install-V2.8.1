                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                src="{{\App\CentralLogics\Helpers::get_image_helper($shop,'logo', asset('storage/app/public/store/').'/'.$shop->logo, asset('assets/admin/img/image-place-holder.png'), 'store/') }}" alt="Product thumbnail"/>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                src="{{\App\CentralLogics\Helpers::get_image_helper($shop,'cover_photo', asset('storage/app/public/store/cover/').'/'.$shop->cover_photo, asset('assets/admin/img/restaurant_cover.jpg'), 'store/cover/') }}" alt="Product thumbnail"/>
                            </div>
                            <div class="custom-file">
