                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            <img src="{{\App\CentralLogics\Helpers::get_image_helper($banner,'image', asset('storage/app/public/banner/').'/'.$banner['image'], asset('assets/admin/img/upload-4.png'), 'banner/') }}"
                                            id="viewer"
