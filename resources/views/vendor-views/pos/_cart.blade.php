                        ...
                        <tr>
                            <td class="media align-items-center cursor-pointer quick-View-Cart-Item"
                                ...
                                <img class="avatar avatar-sm mr-1 onerror-image"
                                     ...
                                     src="{{\App\CentralLogics\Helpers::get_image_helper($cartItem,'image', asset('storage/app/public/product/').'/'.$cartItem['image'], asset('assets/admin/img/100x100/2.png'), 'product/') }}"
