                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0 text-center">{{translate('messages.featured')}} <span class="input-label-secondary"
                                        data-toggle="tooltip" data-placement="right" data-original-title="{{translate('if_you_turn/off_on_this_featured,_it_will_effect_on_website_&_user_app')}}">
                                        <img src="{{asset('assets/admin/img/info-circle.svg')}}" ="public/img"></span></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="media align-items-center">
                                            <img class="img--ratio-3 w-auto h--50px rounded mr-2 onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($banner,'image', asset('storage/app/public/banner/').'/'.$banner['image'], asset('assets/admin/img/900x400/img1.jpg'), 'banner/') }}"
