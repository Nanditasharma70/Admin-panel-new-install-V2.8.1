                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h-100 d-flex align-items-center flex-column">
                                ...
                                <label class="text-center my-auto position-relative d-inline-block">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($category,'image', asset('storage/app/public/category/').'/'.$category['image'], asset('assets/admin/img/upload-img.png'), 'category/') }}"
...
@push('script_2')
    ...
    <script>
        ...
        $('#reset_btn').click(function(){
            ...
            $('#viewer').attr('src', "{{\App\CentralLogics\Helpers::get_image_helper($category,'image', asset('storage/app/public/category/').'/'.$category['image'], asset('assets/admin/img/upload-img.png'), 'category/') }}");
        })
