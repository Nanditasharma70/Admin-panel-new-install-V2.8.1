                        ...
                        <div class="col-lg-6">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <div class="text-center py-3 my-auto">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($notification,'image', asset('storage/app/public/notification/').'/'.$notification['image'], asset('assets/admin/img/900x400/img1.jpg'), 'notification/') }}"
