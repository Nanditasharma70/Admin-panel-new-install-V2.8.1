                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0 h-100 d-flex flex-column">
                                ...
                                <div class="text-center py-3 my-auto">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($campaign,'image', asset('storage/app/public/campaign/').'/'.$campaign->image, asset('assets/admin/img/900x400/img1.jpg'), 'campaign/') }}"
