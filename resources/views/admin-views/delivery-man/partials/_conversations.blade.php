    ...
    <div class="card-header">
        <div class="chat-user-info w-100 d-flex align-items-center">
            <div class="chat-user-info-img">
                ...
                src="{{\App\CentralLogics\Helpers::get_image_helper($user,'image', asset('storage/app/public/profile/').'/'.$user['image'], asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}"
                ...
                @if($con->sender_id == $user->id)
                    <div class="py-2 d-flex gap-2 align-items-end">
                        <div class="chat-user-conv-img">
                            <img class="avatar-img onerror-image" width="28" height="28" src="{{\App\CentralLogics\Helpers::get_image_helper($user,'image', asset('storage/app/public/profile/').'/'.$user['image'], asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}" data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}" alt="Image Description">
                        </div>
